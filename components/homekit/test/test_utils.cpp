...
TEST_CASE("Test hex_c_to_bin_c \"0xA\" == 0b1010", "[pass]") {
  TEST_ASSERT_EQUAL_INT(0b1010, internal::hex_c_to_bin_c('a'));
  TEST_ASSERT_EQUAL_INT(0b1010, internal::hex_c_to_bin_c('A'));
}

TEST_CASE("Test hex_c_to_bin_c \"0x5\" == 0b0101", "[pass]") {
  TEST_ASSERT_EQUAL_INT(0b0101, internal::hex_c_to_bin_c('5'));
}
