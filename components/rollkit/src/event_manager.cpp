...
void EventManager::register_for_events(interfaces::ISession* session, uint64_t char_id) {
  _event_subs[session].push_back(char_id);
}

void EventManager::unregister_for_events(interfaces::ISession* session, uint64_t char_id) {
